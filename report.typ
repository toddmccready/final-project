...
Initiation involves the assembly of the preinitiation complex (PIC) at the gene promoter. Under the classic model of PIC assembly, general transcription factors (GTFs) and RNAP sequentially bind to the promoter in a specific order(reviewed in @baek_single_2021). Promoter escape then marks the transition to elongation, characterized by the phosphorylation of the RNAP II C-terminal domain(CTD) and the exchange of initiation factors for elongation factors@baek_single_2021. 
